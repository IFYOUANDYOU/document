...
export const uploadSymbolImg = params => { return new Request().post(`${SEVER_HOST}examQuestion/symbolUpload/${params.examId}/${params.questionId}`, params, { 'Content-Type': 'application/json' }) }
